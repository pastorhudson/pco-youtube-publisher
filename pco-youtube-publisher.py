...
def get_youtube_json_payload_from_rss(channel_id):
    ...
    for e in entry:
        ...
        elements.append(
            f"""<p><iframe width="560" height="315" src="{e.link.replace('watch?v=', '/embed/', 1)}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>"""
            )
    elements.append(
